...
namespace GrooveOn.Services.Services
{
    public class QuestionService 
        : BaseCRUDService<QuestionResponse, BaseSearchObject, Question, QuestionUpsertRequest, QuestionUpsertRequest>, IQuestionService
    {
        ...
        protected override IQueryable<Question> AddInclude(IQueryable<Question> query, BaseSearchObject search)
        {
        ...
        protected override IQueryable<Question> ApplyFilter(IQueryable<Question> query, BaseSearchObject? search = null)
        {
